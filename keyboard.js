...
function showContent() {
  const content = `<div class="wrapper">
                        ...
                        <div class="keyboard">
                            <div class="first-row">
                                <div class="key letter symbol" data-back="backquote" id='Backquote'>\`</div>
                            ...
                            <div class="second-row">
                                ...
                                <div class="key letter" data-back="q" id="KeyQ">q</div>
                                <div class="key letter" data-back="w" id="KeyW">w</div>
                                <div class="key letter" data-back="e" id="KeyE">e</div>
                                <div class="key letter" data-back="r" id="KeyR">r</div>
                                <div class="key letter" data-back="t" id="KeyT">t</div>
                                <div class="key letter" data-back="y" id="KeyY">y</div>
                                <div class="key letter" data-back="u" id="KeyU">u</div>
                                <div class="key letter" data-back="i" id="KeyI">i</div>
                                <div class="key letter" data-back="o" id="KeyO">o</div>
                                <div class="key letter" data-back="p" id="KeyP">p</div>
                                <div class="key letter symbol" data-back="[" id="BracketLeft">[</div>
                                <div class="key letter symbol" data-back="]" id="BracketRight">]</div>
                            ...
                            <div class="third-row">
                                ...
                                <div class="key letter" data-back="a" id="KeyA">a</div>
                                <div class="key letter" data-back="s" id="KeyS">s</div>
                                <div class="key letter" data-back="d" id="KeyD">d</div>
                                <div class="key letter" data-back="f" id="KeyF">f</div>
                                <div class="key letter" data-back="g" id="KeyG">g</div>
                                <div class="key letter" data-back="h" id="KeyH">h</div>
                                <div class="key letter" data-back="j" id="KeyJ">j</div>
                                <div class="key letter" data-back="k" id="KeyK">k</div>
                                <div class="key letter" data-back="l" id="KeyL">l</div>
                                <div class="key letter symbol" data-back=";" id="Semicolon">;</div>
                                <div class="key letter symbol" data-back="quotes" id="Quote">'</div>
                            ...
                            <div class="fourth-row">
                                ...
                                <div class="key letter" data-back="z" id="KeyZ">z</div>
                                <div class="key letter" data-back="x" id="KeyX">x</div>
                                <div class="key letter" data-back="c" id="KeyC">c</div>
                                <div class="key letter" data-back="v" id="KeyV">v</div>
                                <div class="key letter" data-back="b" id="KeyB">b</div>
                                <div class="key letter" data-back="n" id="KeyN">n</div>
                                <div class="key letter" data-back="m" id="KeyM">m</div>
                                <div class="key letter symbol" data-back="comma" id="Comma">,</div>
                                <div class="key letter symbol" data-back="period" id="Period">.</div>
                                <div class="key symbol" data-back="slash" id="Slash">/</div>
                        ...
                        <div class="addition">
                            <p data-back="system">keyboard created in windows system</p>
                            <p data-back="changing">for changing language: ctrl + alt</p>
                        </div>
                    </div>`;
...
const data = document.querySelectorAll('[data-back]');
...
function getTranslate() {
  data.forEach((el) => {
    const elem = el;
    elem.textContent = letter[language][elem.dataset.back];
  });
}
...
function changeLanguage() {
  ...
  if (isCapsLocked) {
    data.forEach((el) => {
      const elem = el;
      elem.textContent = letter[language][elem.dataset.back].toUpperCase();
    });
  } else if (!isCapsLocked) {
    data.forEach((el) => {
      const elem = el;
      elem.textContent = letter[language][elem.dataset.back].toLowerCase();
    });
  }
}
